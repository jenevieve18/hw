<%@ Page language="c#" Codebehind="options.aspx.cs" AutoEventWireup="false" Inherits="eform.options" %>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="text">
    ...
    <form id="options" method="post" runat="server">
		<button onclick="location.href='questions.aspx';">Cancel</button><button onclick="location.href='optionSetup.aspx';return false;">Add new</button><asp:DropDownList ID=OptionContainerID AutoPostBack=True Runat=server/>
		<br/><br/>
		<table border="0" cellspacing="0" cellpadding="0">
			<tr><td><u>Option</u>&nbsp;</td><td><u>Type</u>&nbsp;</td><td>&nbsp;</td></tr>
