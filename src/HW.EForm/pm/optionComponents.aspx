<%@ Page language="c#" Codebehind="optionComponents.aspx.cs" AutoEventWireup="false" Inherits="eform.optionComponents" %>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="text">
    ...
    <form id="optionComponents" method="post" runat="server">
		<button onclick="location.href='options.aspx';">Cancel</button><button onclick="location.href='optionComponentSetup.aspx';return false;">Add new</button><asp:DropDownList ID=OptionComponentContainerID AutoPostBack=True Runat=server/>
		<br/><br/>
		<table border="0" cellspacing="0" cellpadding="0">
			<tr><td><B>Answer option</B>&nbsp;</td><td><B>Default export value</B>&nbsp;</td><td>&nbsp;</td></tr>
