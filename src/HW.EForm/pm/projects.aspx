<%@ Page language="c#" Codebehind="projects.aspx.cs" AutoEventWireup="false" Inherits="eform.projects" %>
		...
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="text">
			...
			<tr> 
				...
				<br/>
					...
					<form id="projects" method="post" runat="server">
							<table border="0" cellspacing="0" cellpadding="0">
								<tr><td colspan="4"><button onclick="location.href='projectSetup.aspx';return false;">Add new project</button></td></tr>
								<tr><td colspan="4">&nbsp;</td></tr>
								<tr><td colspan="4" bgcolor="#CCCCCC"><img src="../img/null.gif" width="1" height="1"></td></tr>
								<tr><td colspan="4">&nbsp;</td></tr>
								<tr><td colspan="4"><u>Projects</u></td></tr>
								<tr><td colspan="4">&nbsp;</td></tr>
