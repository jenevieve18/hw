<%@ Page language="c#" Codebehind="surveys.aspx.cs" AutoEventWireup="false" Inherits="eform.surveys" %>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="text">
	...
	<tr> 
		...
		<br/>
    <form id="surveys" method="post" runat="server">
		<button onclick="location.href='surveySetup.aspx';return false;">Add new</button>
		<br/><br/>
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td><u>Survey</u>&nbsp;</td>
				<td><u>Actions</u>&nbsp;</td>
				<td><u>Used in project(s)</u>&nbsp;</td>
			</tr>
