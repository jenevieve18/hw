<%@ Page language="c#" Codebehind="idx.aspx.cs" AutoEventWireup="false" Inherits="eform.idx" %>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="text">
    ...
    <form id="idx" method="post" runat="server">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr><td colspan="4"><button onclick="location.href='idxSetup.aspx';return false;">Add new index</button></td></tr>
				<tr><td colspan="4">&nbsp;</td></tr>
				<tr><td colspan="4" bgcolor="#CCCCCC"><img src="../img/null.gif" width="1" height="1"></td></tr>
				<tr><td colspan="4">&nbsp;</td></tr>
				<tr><td colspan="4"><u>Indexes</u></td></tr>
				<tr><td colspan="4">&nbsp;</td></tr>
