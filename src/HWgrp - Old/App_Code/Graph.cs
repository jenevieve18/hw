...
public class Graph
{
		...
		)
	{
		...
		objGraphics.DrawString(tr, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 433, 137, drawFormatCenter);
		objGraphics.DrawString(cr, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 433, 270, drawFormatCenter);
		objGraphics.DrawString(lr, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 433, 403, drawFormatCenter);

		objGraphics.DrawString(tc, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 300, 137, drawFormatCenter);
		objGraphics.DrawString(cc, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 300, 270, drawFormatCenter);
		objGraphics.DrawString(lc, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 300, 403, drawFormatCenter);

		objGraphics.DrawString(tl, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 166, 137, drawFormatCenter);
		objGraphics.DrawString(cl, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 166, 270, drawFormatCenter);
		objGraphics.DrawString(ll, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 166, 403, drawFormatCenter);


		objGraphics.DrawString(ctr, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 433, 167, drawFormatCenter);
		objGraphics.DrawString(ccr, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 433, 300, drawFormatCenter);
		objGraphics.DrawString(clr, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 433, 433, drawFormatCenter);

		objGraphics.DrawString(ctc, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 300, 167, drawFormatCenter);
		objGraphics.DrawString(ccc, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 300, 300, drawFormatCenter);
		objGraphics.DrawString(clc, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 300, 433, drawFormatCenter);

		objGraphics.DrawString(ctl, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 166, 167, drawFormatCenter);
		objGraphics.DrawString(ccl, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 166, 300, drawFormatCenter);
		objGraphics.DrawString(cll, new Font("Arial", 20), new SolidBrush(ColorTranslator.FromHtml("#000000")), 166, 433, drawFormatCenter);
	...
	public void drawBottomString(string s, int cx, bool vert)
	{
		if (vert)
		{
			objGraphics.TranslateTransform(0, h);
			objGraphics.RotateTransform(90F);
			objGraphics.DrawString(s, (new Font(font, fontSize)), (new SolidBrush(ColorTranslator.FromHtml("#000000"))), topSpacing + Convert.ToInt32(maxH) + 15 - h, -leftSpacing - cx * steping - 10, drawFormatNear);
			objGraphics.ResetTransform();
		}
		else
		{
			objGraphics.DrawString(s, (new Font(font, fontSize)), (new SolidBrush(ColorTranslator.FromHtml("#000000"))), leftSpacing + cx * steping, topSpacing + Convert.ToInt32(maxH) + 15, drawFormat);
		}
	}
	...
	public void drawMultiBar(int color, int i, float v, int s, int b, int barDivision, int align, int occupy, bool writeN, bool percent)
	{
		...
		objGraphics.DrawRectangle(new Pen(ColorTranslator.FromHtml("#000000")), x, topSpacing + dMaxH + atH, b / barDivision, Convert.ToInt32((Convert.ToDouble(v) - minVal) / (maxVal - minVal) * mMaxH));
		objGraphics.FillRectangle(new SolidBrush(ColorTranslator.FromHtml("#" + colors[color])), x + 1, topSpacing + 1 + dMaxH + atH, b / barDivision - 1, Convert.ToInt32((Convert.ToDouble(v) - minVal) / (maxVal - minVal) * mMaxH) - 1);
		if (barDivision <= 2)
		{
			objGraphics.FillRectangle(new SolidBrush(ColorTranslator.FromHtml("#999999")), x + b / barDivision + 1, topSpacing + 2 + dMaxH + atH, 2, Convert.ToInt32((Convert.ToDouble(v) - minVal) / (maxVal - minVal) * mMaxH) - 2);
		}
		if (writeN && b / barDivision > 30)
		{
			objGraphics.DrawString(v.ToString() + (percent ? "%" : ""), (new Font(font, smallFontSize)), (new SolidBrush(ColorTranslator.FromHtml("#000000"))), x + (b / barDivision - 1) / 2, topSpacing + 2 + dMaxH + (atH > mMaxH / 5 ? atH - 15 : atH + 15), drawFormatCenter);
		}
	}
