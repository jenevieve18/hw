<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="managerFuncEdit.aspx.cs" Inherits="HW.Adm.managerFuncEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="500" border="0" cellspacing="0" cellpadding="0">
			<tr><td style="font-size:16px;" align="center">Edit Manager Function</td></tr>
		</table>
