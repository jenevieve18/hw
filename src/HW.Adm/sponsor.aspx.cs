...
namespace HW.Adm
{
    public partial class sponsor : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (HttpContext.Current.Request.QueryString["ExportExtendedSponsorID"] != null)
                {
                ...
                {
                    execExportMetadata(HttpContext.Current.Request.QueryString["ExportSponsorID"].ToString());
                }
                if (HttpContext.Current.Request.QueryString["COPY"] != null)
                {
                    ...
                    if (System.IO.File.Exists(Server.MapPath("img/sponsor/" + oldSponsorKey + Convert.ToInt32(HttpContext.Current.Request.QueryString["COPY"]).ToString() + ".gif")))
                    {
                        System.IO.File.Copy(
                            Server.MapPath("img/sponsor/" + oldSponsorKey + Convert.ToInt32(HttpContext.Current.Request.QueryString["COPY"]).ToString() + ".gif"),
