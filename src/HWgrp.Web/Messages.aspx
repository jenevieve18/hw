<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
	CodeBehind="Messages.aspx.cs" Inherits="HWgrp.Web.Messages" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div id="contextbar">
		<div class="settingsPane">
			...
			message, confirm with password
			<asp:TextBox ID="Password" runat="server" TextMode="Password" />
			<asp:Button ID="Send" runat="server" Text="Send" CssClass="btn" />
		</div>
	</div>
	<div class="smallContent">
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					<b>Registration invitation subject/message *</b> (<span style="font-size: 9px;">Last
						sent:
						<asp:Label ID="InviteLastSent" runat="server" /></span>)
				</td>
				<td rowspan="9">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
				<td bgcolor="#CCCCCC" rowspan="9">
					<img src="img/null.gif" width="1" height="1" />
				</td>
				<td rowspan="9">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
				<td>
					<b>Login reminder subject/message</b> (<span style="font-size: 9px;">Last sent:
						<asp:Label ID="LoginLastSent" runat="server" /></span>)
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					...
					<br />
					Automatically perform check and send every
					<asp:DropDownList ID="LoginWeekday" runat="server">
					...
					<br />
					<br />
					<i>The automatic send in every day mode will only execute once/week/user.</i>
				</td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				<td>
					<b>Registration reminder subject/message **</b> (<span style="font-size: 9px;">Last
						sent:
						<asp:Label ID="InviteReminderLastSent" runat="server" /></span>)
				</td>
				<td>
					<asp:Label Visible="false" ID="ExtendedSurvey" runat="server" /><asp:Label Visible="false"
						ID="ExtendedSurveyFinished" runat="server" />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td>
					<b>Message to all activated users</b> (<span style="font-size: 9px;"><asp:Label ID="AllMessageLastSent"
						runat="server" /></span>)
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					* Sent only once to each individual (status is reset upon email address change)<br />
					** Sent only to individuals who have received invitation but not activated their
					account
				</td>
			</tr>
		</table>
