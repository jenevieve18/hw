<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManagerSetup.aspx.cs" Inherits="HWgrp.Web.ManagerSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div id="contextbar">
		<div class="settingsPane">
			<asp:Button CssClass="btn" ID="buttonCancel" runat=server Text="Cancel" />
			<asp:Button CssClass="btn" ID="buttonSave" runat=server Text="Save" />
