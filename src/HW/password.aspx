<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="password.aspx.cs" Inherits="HW.password" %>
...
<head>
   <%
       ...
       {
           case 1: HttpContext.Current.Response.Write(Db.header2("Nytt lösenord", "Fyll i nytt lösenord här")); break;
