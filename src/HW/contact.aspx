<%@ Page language="c#" Inherits="healthWatch.contact" Codebehind="contact.aspx.cs" %>
<!doctype html>
...
<head>
   <%
       ...
       {
           case 1: HttpContext.Current.Response.Write(healthWatch.Db.header2("Kontakta oss", "HealthWatch c/o Interactive Health Group in Stockholm AB, Box 4047, 10261 Stockholm, Sweden")); break;
           case 2: HttpContext.Current.Response.Write(healthWatch.Db.header2("Contact us", "HealthWatch c/o Interactive Health Group in Stockholm AB, Box 4047, 10261 Stockholm, Sweden")); break;
       }
           %>
</head>
