<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgot.aspx.cs" Inherits="HW.forgot" %>
<!doctype html>
...
<head>
   <%
       ...
       {
           case 1: HttpContext.Current.Response.Write(Db.header2("Glömt lösenord?", "Fyll i din e-postadress här för att återställa ditt lösenord")); break;
