...
namespace HW.Tests.Helpers
{
	...
	public class ExporterTests
	{
		...
		{
			var r = new ReportRepositoryStub().ReadReportPart(1, 1);
			WordDocumentExporter e = new WordDocumentExporter(r);
			e.Export(1, 1, 1, 1, 1, 1, 1, 1, "", "", "");
		}
		
		[Test]
		public void a()
		{
			CreatePackage(@"D:\ian\test\test.docx");
		}
		...
		private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
		{
			...
			Paragraph paragraph1 = new Paragraph(){ RsidParagraphAddition = "00D7203E", RsidParagraphProperties = "00FF10DD", RsidRunAdditionDefault = "00FF10DD" };
			...
			SectionProperties sectionProperties1 = new SectionProperties(){ RsidR = "00D7203E" };
		...
		private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
		{
			...
			RsidRoot rsidRoot1 = new RsidRoot(){ Val = "00FF10DD" };
			Rsid rsid1 = new Rsid(){ Val = "00D7203E" };
			Rsid rsid2 = new Rsid(){ Val = "00FF10DD" };
		...
		private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
		{
			...
			Rsid rsid3 = new Rsid(){ Val = "00FF10DD" };
			...
			SpacingBetweenLines spacingBetweenLines2 = new SpacingBetweenLines(){ After = "300", Line = "240", LineRule = LineSpacingRuleValues.Auto };
			...
			Color color1 = new Color(){ Val = "17365D", ThemeColor = ThemeColorValues.Text2, ThemeShade = "BF" };
			...
			Rsid rsid4 = new Rsid(){ Val = "00FF10DD" };
		...
		private void SetPackageProperties(OpenXmlPackage document)
		{
			...
			document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2013-06-06T06:46:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
			document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2013-06-06T06:46:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
