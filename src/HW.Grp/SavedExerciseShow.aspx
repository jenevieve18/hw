<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SavedExerciseShow.aspx.cs" Inherits="HW.Grp.SavedExerciseShow" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn-pdf').click(function () {
                ...
                doc.addHTML($('#popupie').first(), 0, 0, options, function () {
...
<body class="popup">
    ...
    <form id="form1" runat="server">
        ...
        <div class="popupie" class="popupie">
            <div class="header">
