...
//		INewsRepository newsRepo;
        ...
        */
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Write(Session["IPAddress"]);
                var ipData = Session["IPAddress"];
                if (ipData != null)
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "Data", "<script language='JavaScript'>alert('" + ipData + "');</script>");
                    return;
                }
