	...
	<div class="contentgroup grid_16">
		...
		<div class="smallContent">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><b><%= R.Str(lid, "registration.invitation.subject", "Registration invitation subject/message *")%></b> (<span style="font-size:9px;">Last sent: <asp:Label ID=InviteLastSent runat=server /></span>)</td>
					<td rowspan="9">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td bgcolor="#CCCCCC" rowspan="9"><img src="img/null.gif" width="1" height="1" /></td>
					<td rowspan="9">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td><b><%= R.Str(lid, "login.reminder.subject", "Login reminder subject/message")%></B> (<span style="font-size:9px;">Last sent: <asp:Label ID=LoginLastSent runat=server /></span>)</td>
				</tr>
				<tr>
				...
				<tr>
					<td><b><%= R.Str(lid, "registration.reminder.subject", "Registration reminder subject/message **")%></b> (<span style="font-size:9px;">Last sent: <asp:Label ID=InviteReminderLastSent runat=server /></span>)</td>
