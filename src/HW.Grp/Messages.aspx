<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Messages.aspx.cs" Inherits="HW.Grp.Messages" ValidateRequest="false" %>

<%@ Import Namespace="HW.Grp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        #<%= textBoxPassword.ClientID %> {
            width: 150px;
        }
    </style>
</asp:Content>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td bgcolor="#CCCCCC" rowspan="9">
                        <img src="assets/theme1/img/null.gif" width="1" height="1" /></td>
                    <td rowspan="9">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="textBoxInviteSubject" runat="server" Width="460" /></td>
                    <td>
                        <asp:TextBox ID="textBoxLoginSubject" runat="server" Width="460" /></td>
                </tr>
                <tr>
                    <td valign="top">
                        <asp:TextBox ID="textBoxInviteTxt" runat="server" TextMode="MultiLine"
                    ...
                    <td>
                        ...
                        <br />
                        <i><%= R.Str(lid, "send.auto.day", "The automatic send in every day mode will only execute once/week/user.")%></i>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;</td>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="textBoxInviteReminderSubject" runat="server" Width="460" /></td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="textBoxInviteReminderTxt" runat="server" TextMode="MultiLine"
                            Rows="10" Width="460" /></td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="textBoxAllMessageSubject" runat="server" Width="460" /></td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox ID="textBoxAllMessageBody" runat="server" TextMode="MultiLine" Rows="10"
                            Width="460" /></td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;</td>
                ...
                <tr>
                    <td><%= R.Str(lid, "send.once", "* Sent only once to each individual (status is reset upon email address change)") %><br />
                        <%= R.Str(lid, "send.only", "** Sent only to individuals who have received invitation but not activated their account")%></td>
                </tr>
            </table>
        </div>
    </div>
