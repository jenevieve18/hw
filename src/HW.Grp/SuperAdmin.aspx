<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="SuperAdmin.aspx.cs" Inherits="HW.Grp.SuperAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="contentgroup grid_16">
        <div class="search">
            ...
            <asp:Button ID="Search" Text="Search" CssClass="btn" runat="server" OnClick="Search_Click" />
        </div>
        ...
        <div class="smallContent">
            ...
            <asp:PlaceHolder ID="ESS" runat="server">
                ...
                <table border="0" cellspacing="0" cellpadding="5">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="MeasureTxt1" runat="server" Text="Measure 1" /></td>
                        <td><b>
                            <asp:TextBox ID="MeasureTxt2" runat="server" Text="Measure 2" /></b></td>
                ...
                <asp:Button Text="Submit" CssClass="btn" ID="submit" runat="server" />
                <br />
                <hr />
            </asp:PlaceHolder>
            ...
            <table border="0" cellspacing="0" cellpadding="5">
                <tr>
                    <td><b><%= R.Str(lid, "unit", "Unit")%></b></td>
                    <td>
                        <asp:TextBox ID="Measure2Txt1" runat="server" Text="Measure 1" /></td>
                    <td><b>
                        <asp:TextBox ID="Measure2Txt2" runat="server" Text="Measure 2" /></b></td>
                    <td><b><%= R.Str(lid, "included.not", "Not included")%></b></td>
            ...
            <br />
            <asp:DropDownList ID="FromDT" runat="server" /> -- 
            <asp:DropDownList ID="ToDT" runat="server" />
            <asp:DropDownList ID="ReportID" runat="server" />
            <asp:Button Text="Submit" CssClass="btn" ID="submit2" runat="server" />
