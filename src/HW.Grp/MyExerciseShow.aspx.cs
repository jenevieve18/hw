    ...
    public partial class MyExerciseShow : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (UID == 0 || HttpContext.Current.Request.QueryString["ExerciseVariantLangID"] == null) {
                ...
                Show(exerciseVariantLangId, UID, userProfileID);
            }
        }
...
//        }
        ...
        public void Show(int exerciseVariantLangId, int UID, int userProfileId)
        {
            if (!IsPostBack)
            {
                er.SaveStats(exerciseVariantLangId, UID, userProfileId);
            }
