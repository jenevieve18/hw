            ...
            if (reportParts != null && reportParts.Count > 0)
            {
                ...
                foreach (var r in reportParts)
                {
                    ...
                    else
                    {
                        ...
                        imageBuilder += "<span class=\"button white small export\">";
                        string exportAllDocXUrl = grpWSUrl + GetExportAllUrl2("docx", additionalQuery);
                        imageBuilder += "<span class=\"hidden hidden-export-docx-url\" data-url=\"" + exportAllDocXUrl + "\">" + exportAllDocXUrl + "</span>";
                        ...
                        imageBuilder += "<span class=\"button white small export\">";
                        string exportAllPptxUrl = grpWSUrl + GetExportAllUrl2("pptx", additionalQuery);
                        imageBuilder += "<span class=\"hidden hidden-export-pptx-url\" data-url=\"" + exportAllPptxUrl + "\">" + exportAllPptxUrl + "</span>";
                        ...
                        imageBuilder += "<a class=\"export-pptx-url\" runat=\"server\" onclick=\"onClicked('docx" + r.ReportPart.Id + "')\">docx</a>";
                        imageBuilder += "</span>";
                        string exportAllXlsUrl = grpWSUrl + GetExportAllUrl2("xls", additionalQuery);
                        imageBuilder += "<span class=\"button white small export\">";
                        imageBuilder += "<span class=\"hidden hidden-export-xls-url\" data-url=\"" + exportAllPptxUrl + "\">" + exportAllXlsUrl + "</span>";
                        ...
                        imageBuilder += "<a class=\"export-xls-url\" runat=\"server\" onclick=\"onClicked('docx" + r.ReportPart.Id + "')\">docx</a>";
                        imageBuilder += "</span>";
                        imageBuilder += "<span class=\"button white small export\">";
                        imageBuilder += HtmlHelper.Anchor(R.Str(lid, "xls.verbose", "xls verbose"), exportAllXlsUrl + "&PLOT=" + PlotType.Verbose, "class='exportall-xls-verbose-url' target='_blank'");
                        imageBuilder += "</span>";
