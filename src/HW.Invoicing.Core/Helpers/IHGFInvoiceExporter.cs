...
//			t3.AddCell(C("FAKTURA", titleFont, Rectangle.NO_BORDER, 5, 2, Element.ALIGN_RIGHT));
...
//			t.AddCell(new PdfPCell(new Phrase(invoice.TotalAmount.ToString("### ##0.00"), boldFont)) { Colspan = 2 });
