...
"@test"["Usr514 completed"] = {
    ...
    '33.Click link "Lägg till användare"': function() {
        act.click(":containsExcludeChildren(Lägg till användare)");
    },
    '34.Type in input "_ctl0:ContentPlaceH..."': function() {
        act.type(":attrRegExp(id:/^_ctl\\d+_ContentPlaceHolder1_Email$/)", "doskete@gmail.com");
    },
    '37.Click submit button "Spara"': function() {
        act.click(":attrRegExp(id:/^_ctl\\d+_ContentPlaceHolder1_SaveUser$/)");
    },
    '38.Click link "Lägg till användare"': function() {
        act.click(":containsExcludeChildren(Lägg till användare)");
    },
    ...
    '43.Click submit button "Avbryt"': function() {
    ...
    '45.Click link "Skicka"': function() {
        act.click(":containsExcludeChildren(Skicka)");
    },
    ...
    '54.Click submit button "Spara"': function() {
        act.click(":attrRegExp(id:/^_ctl\\d+_ContentPlaceHolder1_SaveUser$/)");
    },
    ...
    '65.Click submit button "Spara"': function() {
        act.click(":attrRegExp(id:/^_ctl\\d+_ContentPlaceHolder1_SaveUser$/)");
    },
    ...
    '8.Click label "Uppdatera..."': function() {
    ...
    '76.Click submit button "Spara"': function() {
        act.click(":attrRegExp(id:/^_ctl\\d+_ContentPlaceHolder1_SaveUser$/)");
    },
    ...
    '78.Click submit button "Utför"': function() {
    ...
    '99.Click submit button "Utför"': function() {
        ...
        '225.Click link "Importera enheter"': function() {
    ...
    '210.Click submit button "Spara"': function() {
    ...
    '212.Click submit button "Utför"': function() {
        act.click(":attrRegExp(id:/^_ctl\\d+_ContentPlaceHolder1_SaveDeleteDepartment$/)");
    },
    ...
    '214.Click submit button "Utför"': function() {
        act.click(":attrRegExp(id:/^_ctl\\d+_ContentPlaceHolder1_SaveDeleteDepartment$/)");
    },
